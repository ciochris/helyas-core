...
def build_group_chat_prompt(
    ...
    section1 = (
        ...
        "REGOLA DI QUALITÀ DEL DIBATTITO (obbligatoria):\n"
        "Non devi convergere per forza. Il disaccordo è utile se è sostanziale.\n\n"
        "Ogni tuo intervento deve aggiungere valore reale al dibattito.\n\n"
        "Puoi continuare con STATUS: CONTINUA se stai facendo almeno una di queste:\n"
        "- contestando un punto importante\n"
        "- correggendo un errore\n"
        "- proponendo una soluzione alternativa\n"
        "- semplificando una proposta\n"
        "- evidenziando un rischio concreto\n"
        "- integrando un'informazione nuova\n"
        "- trasformando un'idea vaga in una decisione operativa\n"
        "- chiedendo a Christian una scelta davvero indispensabile\n\n"
        "Non continuare se stai solo:\n"
        "- ripetendo un concetto già detto\n"
        "- confermando genericamente\n"
        "- riformulando con parole diverse\n"
        "- aggiungendo dettagli marginali\n"
        "- allungando il dibattito perché ci sono round disponibili\n\n"
        "Usa STATUS: PRONTO solo quando:\n"
        "- sei realmente allineato con l'altro agente\n"
        "- non hai obiezioni sostanziali\n"
        "- non vedi rischi importanti non discussi\n"
        "- la proposta è abbastanza chiara da essere usata da Christian\n\n"
        "Se hai un disaccordo reale, continua e spiega:\n"
        "1. su cosa non sei d'accordo\n"
        "2. perché è importante\n"
        "3. quale alternativa proponi\n\n"
        "Non usare STATUS: PRONTO per compiacere l'altro agente.\n"
        "Usalo solo quando ritieni davvero che il dibattito abbia raggiunto una conclusione utile.\n"
    )
    if agent_name == "ChatGPT":
        section1 += (
            "\nRUOLO SPECIFICO — ChatGPT:\n"
            "Il tuo ruolo prevalente è review critica: cerca errori, rischi, alternative e semplificazioni. "
            "Non limitarti ad approvare. Se non trovi nulla di concreto da migliorare, usa STATUS: PRONTO.\n"
        )
    elif agent_name == "Claude":
        section1 += (
            "\nRUOLO SPECIFICO — Claude:\n"
            "Il tuo ruolo prevalente è costruire una proposta operativa: integra le critiche, "
            "porta il dibattito verso una soluzione applicabile. "
            "Non fare nuove domande a Christian se potete decidere autonomamente. "
            "Se la proposta è già utilizzabile, usa STATUS: PRONTO.\n"
        )
